...
- Use the native `fetch` API for HTTP requests; do not add axios or similar libraries (removed due to supply chain attack risk; Next.js/Node.js 22 has native fetch)
